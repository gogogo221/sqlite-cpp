...
// configuration step. It creates a namespace called `sqlite_cpp`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", sqlite_cpp::cmake::project_name, sqlite_cpp::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", sqlite_cpp::cmake::project_version);
      return EXIT_SUCCESS;
    }
